...
## ✨ Key Features & Security Architecture (v0.7.4)

| Feature | Description |
| :--- | :--- |
| ⚡ **Distributed State & Redis Cluster** | Enterprise multi-server architecture (`SYNAPSE_REDIS_URL`). Atomic cross-worker replay protection (`SET NX EX`), synchronized IP quarantine, and zero-downtime SQLite fallback (v0.7.4). |
