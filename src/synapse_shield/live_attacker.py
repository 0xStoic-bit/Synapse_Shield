...
def main():
    ...
    print(f"{C.BOLD}{C.YELLOW}║   🔴 SYNAPSE SHIELD v0.4.0 — RED TEAM BOT SALDIRI SÜİTİ     ║{C.END}")
    ...
    res6 = send_attack(
        "Human", {"mouse_movements": human_pts, "clicks": [{"x": 700, "y": 200, "t": t + 1000}]}, ip_suffix=60
    )
